...
namespace SW.Infra.DataContexts
{
    ...
    public class SWDataContextInitializer : DropCreateDatabaseIfModelChanges<SWDataContext>
    {
        protected override void Seed(SWDataContext context)
        {
            ...
            context.Promocoes.Add(new Promocao { Id = 1, Titulo = "3 por 10 reais", Valor = 10, TipoDescontoId = 2 });
            context.Promocoes.Add(new Promocao { Id = 2, Titulo = "Pague 1 e Leve 2", Valor = 2, TipoDescontoId = 1 });
